...
const userDetails = id => {
    ...
    docRef.get().then(doc => {
        if(doc.exists){
            ...
            window.location.assign('file:///C:/Users/Navee/Downloads/HouseRentalSystemUI-master/HouseRentalSystemUI-master/index.html');
        }
    }).catch(err => {
...
login_submit.addEventListener('click' , event => {
    ...
    auth.signInWithEmailAndPassword(email,password).then(cred => {
        swal({
            ...
            document.querySelector('#login').reset()
            loginForm.style.display = 'none'
            window.location.replace('file:///C:/Users/Navee/Downloads/HouseRentalSystemUI-master/HouseRentalSystemUI-master/index.html');
